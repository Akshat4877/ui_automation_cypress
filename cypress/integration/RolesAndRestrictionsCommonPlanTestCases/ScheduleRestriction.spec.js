...
describe("Roles And Restrication For Common Plan(Schedule)", function () {
    ...
    it.only("Navigate to Roles and Restrictions Page For (Schedule)Restriction ", function () {
    ...
    it.only('Select kit type to Configure Restriction For Common Plans(Schedule)', function () {
        const RoleRestr = new RolesAndRestrictionsPage();
        cy.wait(2000)
    ...
    it.only('Apply Schedule Restriction', function () {
        ...
        cy.xpath('//*[text() ="Common Plans"]')
            .within(($Details) => {
                ...
                cy.wait(1000)
                //Click on Schedule
                cy.xpath("//*[@class='v-chip__content' and contains(text(),'Schedule')]")
                    .click({ force: true })
                cy.wait(2000)
    ...
    it.only('Navigate to UI to Validate(Schedule)Restriction', function () {
        //Page Object
        const slp = new SanityLoginPage();
        const lp = new LoginPage();
        //Navigate to url
    ...
    it.only('Validate (Schedule)Restriciton in Common Plans Tab',function(){
      cy.wait(1000)
