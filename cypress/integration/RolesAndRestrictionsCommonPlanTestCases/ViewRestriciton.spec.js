...
describe("Roles And Restrication For Common Plan(View)", function () {
    ...
    it.only('Select kit type to Configure Restriction For Common Plans(View)', function () {
        const RoleRestr = new RolesAndRestrictionsPage();
        cy.wait(2000)
    ...
    it.only('Apply View Restriction', function () {
        ...
        cy.xpath('//*[text() ="Common Plans"]')
            .within(($Details) => {
                ...
                cy.wait(1000)
                //Click on View
                cy.xpath("//*[@class='v-chip__content' and contains(text(),'View')]").eq(0)
                    .click({ force: true })
                cy.wait(2000)
    ...
    it.only('Validate (View)Restriciton for Common Plans Tab',function(){
        //Common Plans Tab should not be visible/exist
        cy.wait(1000);
