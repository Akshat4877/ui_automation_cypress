...
describe("Roles And Restrication For Map(View)", function () {
    ...
    it.only('Apply View Restriction', function () {
        ...
        cy.xpath('//*[text() ="Map"]')
            .within(($Map) => {
                ...
                cy.wait(1000)
                //Click on View
                cy.xpath("//*[@class='v-chip__content' and contains(text(),'View')]").eq(11)
                    .click({ force: true })
                cy.wait(2000)
    ...
    it.only('Validate (View)Restriciton for Map Tab',function(){
        //Map Tab should not be visible/exist
        cy.wait(1000);
        cy.contains(" Map ").should('not.exist') 
    })
