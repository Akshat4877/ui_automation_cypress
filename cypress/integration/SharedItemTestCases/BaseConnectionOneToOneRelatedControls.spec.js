...
describe("Base Connection Shared Kit Item OneToOne Related Control Test Case", function () {
    ...
    this.beforeEach("KitType Data", function () {
        Cypress.Cookies.preserveOnce(
            ...
            cy.fixture("SharedRelationKitItemIdData/OneToOneItemId").then(function (ItemID) {
    ...
    it.only('Open OneToOne Related New in Shared View',function(){
    ...
    it.only("Text Element data Validation", function () {
      ...
      it.only("Slider Element data Validation", function () {
        ...
        cy.xpath('//div[@class="v-input v-input--is-label-active v-input--is-dirty theme--light v-input__slider"]//div[@class="v-slider v-slider--horizontal theme--light"]//input')
          .invoke('val').then((text) => {
            cy.log(text)
            expect(text).equal(this.RelatedKitItemData2.SliderValue)
          })
      })
