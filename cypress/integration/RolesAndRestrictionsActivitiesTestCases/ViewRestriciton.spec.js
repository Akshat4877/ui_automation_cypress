...
describe("Roles And Restrication For Activities(View)", function () {
    ...
    it.only('Select kit type to Configure Restriction For Activities(View)', function () {
        const RoleRestr = new RolesAndRestrictionsPage();
        cy.wait(2000)
    ...
    it.only('Apply View Restriction', function () {
        ...
        cy.xpath('//*[text() ="Activities"]')
            .within(($Activities) => {
                ...
                cy.wait(1000)
                //Click on View
                cy.xpath("//*[@class='v-chip__content' and contains(text(),'View')]").eq(14)
                    .click({ force: true })
                cy.wait(2000)
    ...
    it.only('Validate (View)Restriciton for Activities Tab',function(){
